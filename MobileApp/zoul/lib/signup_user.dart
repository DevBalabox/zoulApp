...
class SignupPage extends StatefulWidget {
  ...
  final String title;
  static _SignupPage of(BuildContext context) =>
      context.ancestorStateOfType(const TypeMatcher<_SignupPage>());
