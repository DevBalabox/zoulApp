...
class _SuscriptionPage extends State<SuscriptionPage> {
  ...
  getStoredData(BuildContext context) async {
    ...
    setState(() {
      ...
      token = widget.token;
      subscription_status =
          jsonDecode(user_data)["subscription_status"] ?? null;
  ...
  setUpSubscription() {
    switch (subscription_status) {
      ...
      case "inactive":
        setState(() {
          subscription_title = "Adquiere tu suscripción por \$99.00 mxn al mes";
        });
        break;
    }
  }
                      ...
                      children: <Widget>[
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            SizedBox(height: 5,),
                            Image.asset("img/stripe-2.png", width: 230),
                          ],
                        ),
                        SizedBox(
                          height: 10,
