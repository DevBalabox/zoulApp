...
if ($user_class->verify_login()) header('Location: ' . $extras_class->coach_home_url);
?>
...
<head>
  ...
  <title>Bienvenido, Coach - <?php getString("main_title") ?></title>
...
<body class="gray-body general">
  ...
  $dataArray = array(
    ...
    "message" => '<span>Si aún no eres coach, puedes resgistrarte en nuestra app. </span>',
