...
';
    ...
    <div class="main">
        ...
        <div class="card">
            <div class="form-cont">
                <span style="font-size: 15px;color: #6d6d6d;">Crea una nueva contraseña y asegúrate de guardarla en algún lugar seguro</span>
                <form id="restoken_form">
                    <input type="hidden" name="restoken" value="<?php echo $_GET["rtk"] ?>">
                    <div class="tag-input">
                        <label class="input-labl">Nueva contraseña</label>
                        <input type="password" name="password" id="password" placeholder="ContraseñaSegura." required>
                    </div>

                    <div class="tag-input">
                        <label class="input-labl">Confirma tu nueva contraseña</label>
                        <input type="password" name="cfpassword" id="cfpassword" placeholder="***********" required>
                    </div>

                    <button type="button" class="send-btn" onclick="saveNewPassword();">Guardar nueva contraseña</button>
                </form>
        ...
        <script>
            ...
            function saveNewPassword() {
                ...
                $("#restoken_form").append('<input type="hidden" name="action" value="set_new_password" id="form_action">');
